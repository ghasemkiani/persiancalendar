...
public class SimplePersianCalendar extends GregorianCalendar implements PersianCalendarConstants {
  /**
   * Constructs a new {@code SimplePersianCalendar} instance.
   * This constructor initializes a new SimplePersianCalendar object for Persian calendar operations.
   */
  public SimplePersianCalendar() {}
  private static String copyright = "Copyright \u00a9 2003-2005 Ghasem Kiani <ghasemkiani@gmail.com>. All Rights Reserved.";
